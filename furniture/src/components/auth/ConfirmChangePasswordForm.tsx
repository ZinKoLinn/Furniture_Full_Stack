...
export function ConfirmChangePasswordForm({
  className,
  ...props
  ...
  function onSubmit(values: z.infer<typeof FormSchema>) {
    ...
    setClientError(null);
    submit(values, { method: "POST", action: "/change/confirm" });
  }
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <div className="flex flex-col items-center gap-2 text-center">
        <Link to="#" className="flex flex-col items-center gap-2 font-medium">
          ...
          <span className="sr-only">Your New Password</span>
        </Link>
        <h1 className="text-xl font-bold">Please type your new password.</h1>
        <FieldDescription>
